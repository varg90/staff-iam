...
namespace :db do
  ...
  task raw_setup: :environment do
    ...
    # This task is not the only way to setup, you could just use `bin/rails db:setup`,
    # but you would need higher privileges on the database user, which is bad.
